...
/// @brief Gets the values of all parameters in std::vector<std::pair<String, String>>
/// @return The values of the parameters as a map
std::map<String, std::map<String, double>> ParameterGetter::getParameterValues() {
...
std::map<String, std::vector<String>> ParameterGetter::listAllParameters() {
